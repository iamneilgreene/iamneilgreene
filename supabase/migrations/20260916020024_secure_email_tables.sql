...
alter table ng_email_contacts enable row level security;
alter table ng_email_requests enable row level security;
alter table ng_email_reminders enable row level security;
alter table ng_email_rate_limits enable row level security;
revoke all on ng_email_contacts, ng_email_requests, ng_email_reminders, ng_email_rate_limits from anon, authenticated;
commit;
